...
public class MonthAdapter
    ...
    public MonthAdapter(Context context, TypedArray typedArray, DatePickerController datePickerController, DayPickerView.DataModel dataModel) {
        mContext = context;
...
//            onDayTapped(new CalendarDay(System.currentTimeMillis()));
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        final MonthView monthView = new MonthView(mContext, typedArray, dataModel);
