...
public class DayPickerView extends RecyclerView {
    ...
    protected void setUpAdapter() {
        if (mAdapter == null) {
            mAdapter = new MonthAdapter(getContext(), typedArray, mController, dataModel);
            setAdapter(mAdapter);
        }
    ...
    private void scrollToSelectedPosition(MonthAdapter.SelectedDays<MonthAdapter.CalendarDay> selectedDays, int monthStart) {
...
//        public enum TYPE {TYPE_MULTI, TYPE_RANGE, TYPE_ONLY_READ}
        ...
        public List<MonthAdapter.CalendarDay> invalidDays;   // 无效的日期
        public List<MonthAdapter.CalendarDay> busyDays;      // 被占用的日期
        public MonthAdapter.SelectedDays<MonthAdapter.CalendarDay> selectedDays;  // 默认选择的日期
        public int leastDaysNum;                                   // 至少选择几天
        public int mostDaysNum;                                    // 最多选择几天
        public List<MonthAdapter.CalendarDay> tags;          // 日期下面对应的标签
